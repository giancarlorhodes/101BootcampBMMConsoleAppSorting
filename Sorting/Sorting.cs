...
namespace Sorting
{
    class Sorting
    {
        ...
        internal List<int> ListOfIntegers { get; set; }
        ...
        public Sorting()
        {
            ...
            {
                ListOfIntegers.Add(rnd.Next(0, 100000));
            }
        }
        ...
        public void BubbleSort()
        {
            ...
            // 12, 5, 7, 10, 1, 160 arranged in ascending order are 1, 5, 7, 10, 12, 160. descending it opposite.
            ...
            // step 3 continue this process until you got thru the loop entirely without ever flipping elements
            ...
            while (IsFlipped >= 0)
            {
                ...
                IsFlipped = -1;
                while (IsNotThruArray) // this loop will be used to go thru the array entirely one time pass.
                {
